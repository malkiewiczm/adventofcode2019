...
static inline void run_program(Vec &ops, const char *input_str)
{
	unsigned PC = 0;
	int64_t base = 0;
	for ( ; ; ) {
...
int main(int argc, char **argv)
{
	...
	fclose(f);
#ifdef PARTONE
	const char *const script = "NOT J J\n\
	AND D J\n\
	NOT C T\n\
	AND T J\n\
	NOT A T\n\
	...
	";
#else
	const char *const script = "NOT A J\n\
	NOT B T\n\
	OR T J\n\
	NOT C T\n\
	OR T J\n\
